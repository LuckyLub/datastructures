...
class Queue:
    ...
    def leaves(self, index):
        if self.size == self.free_places:
            print("Your list is empty")
        elif index > self.size:
            print(f'The size of the queue is {self.size}. Your input of {index} is to large.')
        elif index < 1:
            print(f"The number leaving the queue can not be zero or negative.")
        else:
            index -= 1
